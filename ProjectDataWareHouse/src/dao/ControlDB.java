...
//		Connection conn = DBConnection.getConnection("controldb");
	...
	// Phương thức chèn giá trị đọc được ở bên dataprocess vào bảng có trong
	// database staging, giá trị có
	// được từ quá trình đọc file (file .txt hoặc file .xlsx):
	public boolean insertValues(String fieldName, String values, String targetTable) throws SQLException {
...
//	 Phương thức chọn tất cả các trường có trong table ở database staging
	public static ResultSet selectAllField(String db_name, String table_name) {
		...
		try {
			...
			Connection conn = DBConnection.getConnection("database_staging");
