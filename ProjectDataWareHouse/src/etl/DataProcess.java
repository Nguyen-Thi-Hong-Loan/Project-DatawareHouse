	...
	public void writeDataToWareHouse(ResultSet rs) {
		try {
			while (rs.next()) {
				...
				//insert into student values('18130002','Lưu Văn','An','2020-01-01','DH18DTC','CÔNG NGHỆ THÔNG TIN','0879234555','18130002@st.hcmuaf.edu.vn','Vũng Tàu','N/A')
				//('18130002','Lưu Văn','An','2020-01-01','DH18DTC','CÔNG NGHỆ THÔNG TIN','0879234555','18130002@st.hcmuaf.edu.vn','Vũng Tàu','N/A)
